...
#[openapi(
    paths(
        ...
        crate::routes::api::system::diagnostics,
        crate::routes::api::system::logs,
        crate::routes::api::system::get_config,
        crate::routes::api::system::update_config,
        crate::routes::api::system::restart,
        crate::routes::api::system::self_update,
    ...
    components(
        schemas(
            ...
            crate::routes::api::system::DiagnosticsResponse,
            crate::routes::api::system::LogsResponse,
            crate::routes::api::system::ConfigResponse,
            crate::routes::api::system::UpdateConfigRequest,
            crate::routes::api::system::ActionResponse,
            crate::routes::api::system::SelfUpdateRequest,
            crate::config::AppConfig,
            crate::config::DaemonConfig,
            crate::config::ProxmoxConfig,
            crate::config::ApiConfig,
            crate::config::AuthConfig,
            crate::config::DhcpConfig,
