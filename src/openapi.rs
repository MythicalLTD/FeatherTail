...
#[openapi(
    paths(
        ...
        crate::routes::api::proxmox::execute,
        crate::routes::api::proxmox::proxy_json_get,
        crate::routes::api::proxmox::proxy_json_post,
        crate::routes::api::proxmox::proxy_json_put,
        crate::routes::api::proxmox::proxy_json_delete,
        crate::routes::api::proxmox::proxy_extjs_get,
        crate::routes::api::proxmox::proxy_extjs_post,
    ...
    components(
        schemas(
            ...
            crate::routes::api::proxmox::ExecuteProxmoxRequest,
            crate::routes::api::proxmox::ExecuteProxmoxResponse,
            crate::routes::api::proxmox::ProxyParams,
